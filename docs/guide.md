...
The installation steps follow the official [Chrome unpacked extension guide](https://developer.chrome.com/docs/extensions/get-started/tutorial/hello-world#load-unpacked) and [Microsoft Edge sideloading guide](https://learn.microsoft.com/en-us/microsoft-edge/extensions/getting-started/extension-sideloading).

[Companion project](https://github.com/elfmedy/obsidian-ai-inbox) · [Home](../README.md)
